    ...
    <nav class="mt-10">
        <div x-data="{ open: false }">
            ...
            <x-sidebar-item :href="route('dashboard')"
                :active="request()->routeIs('dashboard')">{{ __('Dashboard') }}</x-sidebar-item>
            <x-sidebar-item :href="route('packages.index')"
                :active="request()->routeIs('packages.index')">{{ __('Packages') }}</x-sidebar-item>
            ...
            <!-- <x-sidebar-item :href="route('paybill.index')"
                :active="request()->routeIs('paybill.index')">{{ __('User Management') }}</x-sidebar-item> -->
