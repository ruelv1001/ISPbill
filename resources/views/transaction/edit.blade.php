        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="p-4 sm:p-8">
                    ...
                    <form method="post" action="{{ route('paybill.update', $user->id) }}" class="mt-6 space-y-6">
                        @csrf
                        @method('patch')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    {{ __("Edit user account information") }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="address" name="address" type="text" class="mt-1 block w-full"
                                        value="{{ $user->detail->address }}" required></x-text-input>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full"
                                        value="{{ $user->detail->phone }}" required></x-text-input>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="dob" name="dob" type="date" class="mt-1 block w-full"
                                        value="{{ $user->detail->dob }}" required></x-text-input>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="pin" name="pin" type="text" class="mt-1 block w-full"
                                        value="{{ $user->detail->pin }}" required></x-text-input>
