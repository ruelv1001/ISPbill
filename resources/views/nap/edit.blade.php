        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="p-4 sm:p-8">
                    ...
                    <form method="post" action="{{ route('nap.update', $nap->id) }}"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('NAP') }}</h2>
                            ...
                            <div>
                                <div>
                                    ...
                                    <x-text-input id="nap" name="nap" type="text" required
                                        class="mt-1 block w-full bg-gray-100"
                                        value="{{ old('nap', $nap->nap) }}"></x-text-input>
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="description" name="description" type="text" required
                                        class="mt-1 block w-full bg-gray-100"
                                        value="{{ old('description', $nap->description) }}"></x-text-input>
