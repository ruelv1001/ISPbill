                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-center mb-6 border-b-2 border-slate-100 pb-4">
                        ...
                        <div class="flex items-center">
                            <a href="{{ route('single.download', $user->id) }}"
                            ...
                            <a href="{{ route('package-change', $user->id) }}"
                                class="ml-2 inline-flex items-center px-4 py-2 bg-sky-500 text-white dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs rounded uppercase">
                                {{ __('Change package') }}
                            </a>
                            ...
                            <a href="{{ route('paybill.create', [$user->id]) }}"
                                class="ml-2 inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white rounded uppercase">
                                {{ __('Create') }}
                            </a>
